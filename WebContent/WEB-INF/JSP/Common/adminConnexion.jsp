                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post">
                    <div class="form-group">
                      <input  class="form-control form-control-user" placeholder="Entrer l'identifiant" name="identifiant">
                      <small>${erreurs['pseudo_db']}</small>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Mot de Passe" name="motdepasse">
                      <small>${erreurs['motdepasse_db']}</small>
                    </div>
