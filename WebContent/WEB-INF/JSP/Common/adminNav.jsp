    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="Utilisateurs" data-toggle="collapse" data-target="#collapseUtilities">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Utilisateurs</span></a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Gestion Utilisateurs</h6>
            <a class="collapse-item" href="utilities-color.html">Ajouter Utilisateur</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
      <li class="nav-item active">
        ...
        <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="listRg">Lister Ressources</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
